...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'DEUTSCH­SPRACHIGE_ERSTAUS­STRAHLUNG­'); ?>
		<?php echo $form->textField($model,'DEUTSCH­SPRACHIGE_ERSTAUS­STRAHLUNG­',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'DEUTSCH­SPRACHIGE_ERSTAUS­STRAHLUNG­'); ?>
	</div>
