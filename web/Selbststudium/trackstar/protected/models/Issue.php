...
class Issue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, description, project_id, owner_id, requester_id, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
    ...
    /**
     * Retrieved the list of allowed types
    ...
    {
        return array(
            self::STATUS_NOTYET_STARTED=>'Not yet started',
    ...
    /**
     * Retrieved the list of allowed status options
     * @return array an array of allowed status options.
     */
    public static function getAllowedStatusOptionsRange()
    {
        return array(
            self::STATUS_NOTYET_STARTED,
            self::STATUS_STARTED,
