	...
	<body>
        ...
        <div class="container">
            <div class="page-header">
                <h1>Bugreport<br/>
                <small>Please submit your bug report using this form</small>
                </h1>
            </div>
            ...
            <form class="form-horizontal" action="filebug.php" method="POST">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-lg-2" for="file">Screenshot</label>
                        ...
                        <div class="input-group col-lg-5">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-primary" type="button" onclick="$('#pdffile').click();">Browse...</button>
                            </span>
                        </div>
                        <br/>
                    </div>
